...
{
    /// <summary>
    /// Add base module collection to this builder
    /// </summary>
    bool TryAddBaseCollection(IModuleCollection collection);
    
    /// <summary>
    /// Define new module if it does not exist
    /// </summary>
    bool TryDefineModule(string moduleName);
    
    /// <summary>
    /// Adds dependency from one module to another explicitly.
    /// In default implementation of plamp strongly required for reference from one c# native module to another
    /// </summary>
    bool AddModuleDependencies(string module, params string[] dependencies);
    ...
    bool TryAddMethodDefinition(
        TypeFullName callerTypeFullName, string methodName, 
    ...
    bool TryTypeDefinition(TypeFullName fullName);
    
    /// <summary>
    /// Builds modules into collection
    /// </summary>
    IModuleCollection Build();
}
...
public class MethodCallTests
{
    ...
    [Fact]
    public void EmitActionCall()
    {
        var method = EmissionSetupHelper.MakeFuncRef(typeof(CallbackClass).GetMethod(nameof(CallbackClass.TriggerCallback))!);
        ...
        var (instance, methodInfo) =
            EmissionSetupHelper.CreateInstanceWithMethod([callbackArg], body, typeof(void));
    ...
    [Fact]
    public void EmitStaticActionCall()
    {
        var method = EmissionSetupHelper.MakeFuncRef(typeof(StaticCallbackClass).GetMethod(nameof(StaticCallbackClass.TriggerCallback))!);
        /*
        ...
        var (instance, methodInfo) = EmissionSetupHelper.CreateInstanceWithMethod([], body, typeof(void));
    ...
    [Fact]
    public void EmitActionCallWithArgs()
    {
        ...
        var info = EmissionSetupHelper.MakeFuncRef(typeof(CallbackClassWithArg).GetMethod(nameof(CallbackClassWithArg.TriggerCallback))!);
    ...
    [Fact]
    public void EmitStaticActionCallWithArgs()
    {
        var callback1Arg = new TestParameter(typeof(string), "callbackArg1");
        var callback2Arg = new TestParameter(typeof(int), "callbackArg2");
        var callback3Arg = new TestParameter(typeof(KeyValuePair<int, int>), "callbackArg3");
        var info = EmissionSetupHelper.MakeFuncRef(typeof(StaticCallbackClassWithArg).GetMethod(nameof(StaticCallbackClassWithArg.TriggerCallback))!);
    ...
    [Fact]
    public void EmitCallFunc()
    {
        var callbackArg = new TestParameter(typeof(CallbackFuncClass), "callbackInstance");
        var info = EmissionSetupHelper.MakeFuncRef(typeof(CallbackFuncClass).GetMethod(nameof(CallbackFuncClass.TriggerCallback))!);
        ...
        var body = new BodyNode(
        [
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(EmissionSetupHelper.MakeTypeRef(returnType)), new VariableNameNode(tempVarName)),
        ...
        var (instance, methodInfo) =
            EmissionSetupHelper.CreateInstanceWithMethod([callbackArg], body, returnType);
    ...
    [Fact]
    public void EmitCallStaticFunc()
    {
        var info = EmissionSetupHelper.MakeFuncRef(typeof(StaticCallbackFuncClass).GetMethod(nameof(StaticCallbackFuncClass.TriggerCallback))!);
        /*
         * var temp
        ...
        var body = new BodyNode(
        [
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(EmissionSetupHelper.MakeTypeRef(retType)), new VariableNameNode(tempVarName)),
    ...
    [Fact]
    public void EmitCallFuncWithArgs()
    {
        ...
        var info = EmissionSetupHelper.MakeFuncRef(typeof(CallbackFuncArgClass).GetMethod(nameof(CallbackFuncArgClass.TriggerCallback))!);
    ...
    [Fact]
    public void EmitCallStaticFuncWithArgs()
    {
        var retType = typeof(KeyValuePair<char, char>);
        var callback1Arg = new TestParameter(typeof(string), "callbackArg1");
        var callback2Arg = new TestParameter(typeof(char), "callbackArg2");
        var callback3Arg = new TestParameter(typeof(ValueTask), "callbackArg3");
        var info = EmissionSetupHelper.MakeFuncRef(typeof(StaticCallbackFuncArgClass).GetMethod(nameof(StaticCallbackFuncArgClass.TriggerCallback))!);
    ...
    [Fact]
    public void EmitStructActionCall()
    {
        var retType = typeof(CallbackStruct);
        var method = EmissionSetupHelper.MakeFuncRef(typeof(CallbackStruct).GetMethod(nameof(CallbackStruct.TriggerCallback))!);
        ...
        var (instance, methodInfo) =
            EmissionSetupHelper.CreateInstanceWithMethod([callbackArg], body, retType);
    ...
    //fib :^)
    [Fact]
    public void EmitRecursiveCall()
    {
        const string methodName = "Fibonacci";
        var retType = typeof(int);
        var argType = typeof(int);
        var(typeBuilder, methodBuilder, _) = EmissionSetupHelper.CreateMethodBuilder(methodName, retType, [argType]);
        ...
        [
            ...
            new AssignNode([new MemberNode(nameof(zero))], [new LiteralNode(0, RuntimeSymbols.SymbolTable.Int)]),
            
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.Int), new VariableNameNode(nameof(one))),
            new AssignNode([new MemberNode(nameof(one))], [new LiteralNode(1, RuntimeSymbols.SymbolTable.Int)]),
            
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.Int), new VariableNameNode(nameof(two))),
            new AssignNode([new MemberNode(nameof(two))], [new LiteralNode(2, RuntimeSymbols.SymbolTable.Int)]),
            
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.Int), new VariableNameNode(nameof(eq0))),
            ...
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.Int), new VariableNameNode(nameof(eq1))),
            ...
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.Int), new VariableNameNode(nameof(nm1))),
            ...
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.Int), new VariableNameNode(nameof(nm2))),
            ...
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.Int), new VariableNameNode(nameof(sum))),
    ...
    [Fact]
    public void EmitCallOtherDynamicInSameType()
    {
        const string methodName = "Greet";
        var returnType = typeof(string);
        var (typeBuilder, greetBuilder, _) = EmissionSetupHelper.CreateMethodBuilder(methodName, returnType, []);
         ...
         * return arg
         */
        var mthRef = EmissionSetupHelper.MakeFuncRef(typeof(string).GetMethod(
        ...
        [
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.String),
                new VariableNameNode(nameof(temp1))),
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.String),
                new VariableNameNode(nameof(temp2))),

            new AssignNode([new MemberNode(nameof(temp1))], [new LiteralNode("Hi", RuntimeSymbols.SymbolTable.String)]),
            new AssignNode([new MemberNode(nameof(temp2))], [new LiteralNode("Bye", RuntimeSymbols.SymbolTable.String)]),
        ...
        var body = new BodyNode(
        [
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.String), new VariableNameNode(nameof(temp1))),
            new AssignNode([new MemberNode(nameof(temp1))], [new LiteralNode(literal, RuntimeSymbols.SymbolTable.String)]),
    ...
    public void EmitLateBoundCall(Type instanceType)
    {
        ...
        var body = new BodyNode(
        [
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.Int), new VariableNameNode(nameof(temp1))),
            new AssignNode([new MemberNode(nameof(temp1))], [EmissionSetupHelper.CreateCallNode(new MemberNode(instanceArg.Name), mthRef, [])]),
            new ReturnNode(new MemberNode(nameof(temp1)))
        ]);

        var (instance, method) =
            EmissionSetupHelper.CreateInstanceWithMethod([instanceArg], body, typeof(int));
    ...
    [Fact]
    public void EmitCyclicCallBetween2DynamicTypes()
    {
        const string firstName = "M1";
        var argType = typeof(string);
        var (typeBuilder, methodBuilder, module) =
        ...
        [
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.String), new VariableNameNode(nameof(temp1))),
            new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.Bool), new VariableNameNode(nameof(temp2))),
            new AssignNode([new MemberNode(nameof(temp1))], [new LiteralNode(secondName, RuntimeSymbols.SymbolTable.String)]),
            ...
            new ConditionNode(
                ...
                new BodyNode(
                    [
                        new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.String), new VariableNameNode(nameof(temp3))),
                        new AssignNode([new MemberNode(nameof(temp3))], [new LiteralNode(m1Literal, RuntimeSymbols.SymbolTable.String)]),
                        new ReturnNode(new MemberNode(nameof(temp3)))
                    ]),
                null),
            new AssignNode([new MemberNode(nameof(temp1))], [new LiteralNode(firstName, RuntimeSymbols.SymbolTable.String)]),
        ...
        [
            ...
            new ConditionNode(
                ...
                [
                    new VariableDefinitionNode(EmissionSetupHelper.CreateTypeNode(RuntimeSymbols.SymbolTable.String), new VariableNameNode(nameof(temp3))),
                    new AssignNode([new MemberNode(nameof(temp3))], [new LiteralNode(m2Literal, RuntimeSymbols.SymbolTable.String)]),
                    new ReturnNode(new MemberNode(nameof(temp3)))
                ]),
                null),
            new AssignNode([new MemberNode(nameof(temp1))], [new LiteralNode(secondName, RuntimeSymbols.SymbolTable.String)]),
    ...
    [Fact]
    public void CallWithArrayElementGetter_ReturnsCorrect()
    {
        /*
        ...
        getter.SetItemType(RuntimeSymbols.SymbolTable.Int);
    ...
    public void NonVoidCallWithoutAssign_ReturnsSuccess()
    {
        ...
        var (typeBuilder, methodBuilder) = EmissionSetupHelper.CreateInstanceWithMethod([arg], ast, typeof(void));

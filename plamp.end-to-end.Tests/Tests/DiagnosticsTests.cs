...
public class SyntaxDiagnosticsTests
{
    ...
    public static TheoryData<string, string> InvalidPrograms => new()
    {
        ...
        { InvalidFile("InvalidMixedMultiResultAssignment.plp"), PlampExceptionInfo.CannotMixMultiResultCallInAssignment().Code },
        { InvalidFile("InvalidIgnoredMultiResultCall.plp"), PlampExceptionInfo.CannotUseMultiResultCallAsExpression().Code },
        { InvalidFile("InvalidMultiReturnValueCount.plp"), PlampExceptionInfo.ReturnValueCountMismatch(2, 1).Code },
        { InvalidFile("InvalidMultiResultTargetCount.plp"), PlampExceptionInfo.AssignSourceAndTargetCountMismatch().Code },
